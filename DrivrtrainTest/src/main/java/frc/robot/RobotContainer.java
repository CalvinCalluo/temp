...
public class RobotContainer { 
  ...
  private final motorSubsystem driveTrainSubsystem = new motorSubsystem();
  ...
  public RobotContainer() {
    ...
    driveTrainSubsystem.setDefaultCommand(new ArcadeDriveCmd(driveTrainSubsystem, () -> stick.getRawAxis(1), () -> -stick.getRawAxis(4)));
    configureBindings();
  }
